(function() {
  ...
  Gallery = (function(_super) {
    ...
    Gallery.prototype._onThumbChange = function() {
      ...
      this.curOriginName = curThumb.data("image-name") || curThumbImg.attr("alt") || "图片";
      this.curOriginSrc = curThumb.data("image-src") || this.curThumbSrc;
    ...
    Gallery.prototype._getCurOriginSize = function() {
      var curOriginSize;
      curOriginSize = this.curThumb.data("image-size");
    ...
    Gallery.prototype._createStage = function() {
      ...
      if (this.thumbs.length === 1) {
        this.galleryWrapper.addClass("single");
      }
