(function() {
  ...
  Gallery = (function(_super) {
    ...
    Gallery.prototype._render = function() {
      ...
      this.thumbs = this.curThumb.closest(".attachments, .attachments-preview").find("*[data-origin-src]");
      this._createStage();
      this._createList();
      that = this;
    ...
    Gallery.prototype._createStage = function() {
      ...
      this.loadingEl = this.galleryEl.find(".loading-indicator");
    ...
    Gallery.prototype._createList = function() {
      var galleryMask, that;
      that = this;
      this.thumbsEl = $(Gallery._tpl.thumbs).appendTo(this.galleryWrapper);
      galleryMask = this.thumbsEl.siblings(".gallery-mask");
      ...
      return galleryMask.fadeIn("fast");
    };
    ...
    Gallery.prototype._nextThumb = function() {
      if (this.thumbsEl.find("p:animated").length) {
        return;
      }
      this.thumbsEl.find(".selected").next("p").find("a").click();
      if (this.thumbsEl.find(".selected:hidden").length && this.thumbsEl.find("p:visible").next("p:hidden").length) {
        return this.thumbsEl.find("p:visible").first().animate({
          width: "0",
          opacity: "0",
          margin: "0"
        }, 300, function() {
    ...
    Gallery.prototype._prevThumb = function() {
      if (this.thumbsEl.find("p:animated").length) {
        return;
      }
      this.thumbsEl.find(".selected").prev("p").find("a").click();
      if (this.thumbsEl.find(".selected:hidden").length && this.thumbsEl.find("p:visible").prev("p:hidden").length) {
        return this.thumbsEl.find("p:visible").last().fadeOut(300).end().prev("p:hidden").attr("style", "opacity:0").animate({
          width: "toggle",
          opacity: "1"
        }, 300);
      }
    ...
    Gallery.prototype._fitSize = function(container, size, opts) {
      var result;
      opts = $.extend({
        stretch: false,
        minWidth: 0,
      ...
      if (opts.stretch || size.width > container.width || size.height > container.height || size.width < opts.minWidth || size.height < opts.minHeight) {
    ...
    Gallery.prototype.remove = function() {
      var curThumbSize, that;
      this._unbind();
      $("body").removeClass("no-scroll");
      this.galleryWrapper.removeClass("modal");
      this.imgDetail.fadeOut("fast");
      this.thumbsEl.fadeOut("fast");
      this.thumbsEl.siblings(".gallery-mask").fadeOut("fast");
      this.imgEl.attr("style", "");
      that = this;
      curThumbSize = this._getCurThumbSize();
      this.galleryEl.css(curThumbSize);
