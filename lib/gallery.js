(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simple-gallery', ["jquery","simple-module","simple-util"], function ($, SimpleModule, simpleUtil) {
      return (root['gallery'] = factory($, SimpleModule, simpleUtil));
    });
...
Gallery = (function(superClass) {
  ...
  Gallery._tpl = {
    gallery: "<div class=\"simple-gallery loading\">\n  <div class=\"gallery-img\">\n    <img src=\"\" />\n    <div class=\"loading-indicator\"></div>\n  </div>\n  <div class=\"gallery-detail hide\">\n    <span class=\"name\"></span>\n    <div class=\"gallery-control\">\n      <a class=\"turn-right\" href=\"javascript:;\" title=\"" + (Gallery._t('rotate_image')) + "\"><i class=\"icon-rotate\"><span>" + (Gallery._t('rotate_image')) + "</span></i></a>\n      <a class=\"link-download\" href=\"\" title=\"" + (Gallery._t('download_image')) + "\" target=\"_blank\"><i class=\"icon-download\"><span>" + (Gallery._t('download_image')) + "</span></i></a>\n      <a class=\"link-show-origin\" href=\"\" title=\"" + (Gallery._t('view_full_size')) + "\" target=\"_blank\"><i class=\"icon-external-link\"><span>" + (Gallery._t('view_full_size')) + "</span></i></a>\n    </div>\n  </div>\n</div>",
