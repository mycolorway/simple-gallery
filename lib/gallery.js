...
Gallery = (function(superClass) {
    ...
    return setTimeout(((function(_this) {
      return function() {
        ...
        return _this.util.preloadImages(_this.curOriginSrc, function(originImg) {
          ...
          _this._initRoutate();
          return _this.gallery.one('transitionend webkitTransitionEnd', function() {
  ...
  Gallery.prototype._zoomInPosition = function() {
    var $zoom_in, left, top;
    $zoom_in = $('.zoom-in');
    top = this.gallery.offset().top;
    left = this.gallery.offset().left;
    if (this.rotatedegrees % 180 !== 0) {
      left -= this.gallery.width() - this.gallery.height();
    }
    left = left + this.gallery.width() - $zoom_in.width() - 16;
    $zoom_in.css({
      'top': top,
      'left': left
    });
