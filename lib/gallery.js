(function() {
  ...
  Gallery = (function(_super) {
    ...
    Gallery._tpl = {
      ...
      thumb: "<p class=\"thumb\"><a href=\"javascript:;\" class=\"link\"><img src=\"\" /></a></p>"
    };
    ...
    Gallery.prototype._bind = function() {
      ...
      return $(document).on("keydown.gallery", $.proxy(function(e) {
        ...
        if (/27|32/.test(e.which)) {
          ...
          selectedEl = this.thumbsEl.find(".selected").next(".thumb").find("a").click();
          this._scrollToThumb();
          return false;
        }
      }, this));
    ...
    Gallery.prototype._renderImage = function() {
      ...
      return this.imgDetail.fadeIn("fast");
    };
