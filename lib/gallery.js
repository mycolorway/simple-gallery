...
Gallery = (function(superClass) {
  ...
  Gallery.prototype._render = function() {
    ...
    return setTimeout(((function(_this) {
      return function() {
        ...
        return Util.prototype.preloadImages(_this.curOriginSrc, function(originImg) {
  ...
  Gallery.prototype._renderImage = function() {
    ...
    return this.gallery.addClass('loading').find('.zoom-in').toggle(showZoom);
  };
  ...
  Gallery.prototype._onGalleryThumbClick = function(e) {
    ...
    this._renderImage();
    Util.prototype.preloadImages(this.curOriginSrc, (function(_this) {
      return function(img) {
        if (img.src.indexOf(_this.curOriginSrc) !== -1) {
          _this.gallery.removeClass('loading');
          return _this.img.attr('src', img.src);
        }
      };
    })(this));
    return false;
  ...
  Gallery.prototype._rotate = function() {
    ...
    if (isOrthogonal) {
      if (Util.prototype.browser.firefox && imgSize.height < imgSize.width) {
  ...
  Gallery.prototype._preloadOthers = function() {
    ...
    return Util.prototype.preloadImages($others);
  };
  ...
  Gallery.prototype._renderNatural = function() {
    ...
    return this.wrapper.find('.natural-image img').css('margin', top + " " + left);
  };
  ...
  Gallery.prototype.destroy = function() {
    ...
    this.gallery.css(this.curThumbSize);
    return this.gallery.one(Util.prototype.transitionEnd(), (function(_this) {
      return function(e) {
...
Util = (function(superClass) {
  ...
  Util.prototype.preloadImages = function(images, callback) {
