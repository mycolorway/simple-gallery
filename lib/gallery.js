(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.simple['gallery'] = factory(jQuery,
      SimpleModule,
      simple.util);
  }
...
Gallery = (function(_super) {
  ...
  Gallery._tpl = {
    gallery: "<div class=\"simple-gallery loading\">\n  <div class=\"gallery-img\">\n    <img src=\"\" />\n    <div class=\"loading-indicator\"></div>\n  </div>\n  <div class=\"gallery-detail hide\">\n    <span class=\"name\"></span>\n    <div class=\"gallery-control\">\n      <a class=\"turn-right\" href=\"javascript:;\" title=\"" + (Gallery.prototype._t('download_image')) + "\"><i class=\"fa fa-repeat\"></i></a>\n      <a class=\"link-download\" href=\"\" title=\"" + (Gallery.prototype._t('download_image')) + "\"><i class=\"fa fa-download\"></i></a>\n      <a class=\"link-show-origin\" href=\"\" title=\"" + (Gallery.prototype._t('view_full_size')) + "\" target=\"_blank\"><i class=\"fa fa-external-link\"></i></a>\n    </div>\n  </div>\n</div>",
  ...
  Gallery.prototype._onThumbChange = function() {
    ...
    this.curDownloadSrc = curThumb.data("download-src") || ("" + this.curOriginSrc + "&download=true");
