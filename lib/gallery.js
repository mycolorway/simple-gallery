...
Gallery = (function(superClass) {
  ...
  Gallery.prototype._render = function() {
    Gallery._tpl.gallery = "<div class=\"simple-gallery loading\">\n  <div class=\"gallery-img\">\n    <img src=\"\" />\n    <div class=\"loading-indicator\"></div>\n  </div>\n  <div class=\"gallery-detail hide\">\n    <span class=\"name\"></span>\n    <div class=\"gallery-control\">\n      <a class=\"turn-right\" href=\"javascript:;\" title=\"" + (this._t('rotate_image')) + "\"><i class=\"icon-rotate\"><span>" + (this._t('rotate_image')) + "</span></i></a>\n      <a class=\"link-download\" href=\"\" title=\"" + (this._t('download_image')) + "\" target=\"_blank\"><i class=\"icon-download\"><span>" + (this._t('download_image')) + "</span></i></a>\n      <a class=\"link-show-origin\" href=\"\" title=\"" + (this._t('view_full_size')) + "\" target=\"_blank\"><i class=\"icon-external-link\"><span>" + (this._t('view_full_size')) + "</span></i></a>\n    </div>\n  </div>\n</div>";
